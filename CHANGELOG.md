...
### Changed
- 92fe995 feat: fallback to transcript when last_assistant_message is missing


## [2.2.3] - 2026-04-13

### Changed
- a9aa533 fix: add last_assistant_message to templateData


## [2.2.2] - 2026-04-13

### Changed
- bad583b feat: add last_assistant_message to email templates


## [2.2.1] - 2026-04-13

### Changed
- d03c0d1 feat: auto cleanup SubagentStop hook on event
...
### Fixed
- remove SubagentStop from HookEventType, HOOK_EVENT_TYPES, and all template files
- update CLI help text to reflect supported event types (Notification, Stop only)

## [1.4.6] - 2025-09-29

### Changed
- a8de442 fix(templates): remove HTML tags from email templates for plain text compatibility
